...
| [Technical Overview](docs/TECHNICAL.md) | How CGC works under the hood |
...
**No.** CGC runs locally on your computer. Your data never leaves your machine unless you explicitly expose it.
...
### Q: What's the difference between the regular server and secure server?

- `cgc serve`: No authentication, good for local testing
- `cgc serve --secure`: Requires API keys, use for production or remote access
...
- **Issues**: Report bugs at [GitHub Issues](https://github.com/your-repo/cgc/issues)
- **Documentation**: See the [docs folder](docs/)
- **Examples**: Check [docs/TECHNICAL.md](docs/TECHNICAL.md) for detailed use cases
